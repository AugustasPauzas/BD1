...
@section('content')
<div class="screen_height index_image background_image">
        ...
        <div class="div large_margin_sides ">
            ...
            <div class="row ">
                ...
                @foreach ($data_item as $item)
                    @if ($item->category_id == $category->id && $count >=1)
                        @php $count=$count-1 @endphp
                        <div class="index_item_list   no_padding">
