<section>
    <header>
        ...
        <p class="text-muted small mt-1">
            {{ __(translate("Ensure your account is using a long, random password to stay secure.")) }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-4">
        ...
        <!-- Current Password -->
        <div class="mb-3">
            <label for="update_password_current_password" class="form-label">{{ __(translate("Current Password")) }}</label>
        ...
        <!-- New Password -->
        <div class="mb-3">
            <label for="update_password_password" class="form-label">{{ __(translate("New Password")) }}</label>
        ...
        <!-- Confirm Password -->
        <div class="mb-3">
            <label for="update_password_password_confirmation" class="form-label">{{ __(translate("Confirm Password")) }}</label>
