...
<script type="text/javascript" src="{{ asset('js/view_update_JS.js') }}"></script>
                ...
                <form id="update-item-form" method="POST" data-ajax-url="{{ url('ajax_update_item') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="default_margin default_margin_sides">
                            ...
                            <div class="form-group">
                                <label for="ien_code">{{translate("IEN Code")}}</label>
                            ...
                            <div class=" input-group">
                                <select class="form-group form-select" id="status" name="status">
                                    <option value="1" {{ $data_item->status == 1 ? 'selected' : '' }}> {{translate("Not Public")}}</option>
                                    <option value="2" {{ $data_item->status == 2 ? 'selected' : '' }}> {{translate("Public")}}</option> 
                                </select>
    ...
    <div class="container primary_background_color default_padding default_margin default_radius under_shadow">
        ...
        <div class="d-flex position-relative align-items-center">
            <span class="position-absolute start-50 translate-middle-x">
                <p><strong>{{translate("Full Item Specification")}}</strong></p></span>
            <span class="ms-auto">
        ...
        <div class="row no_margin_sides hide_on_md">
            <div class="update_view_parameter_col"><p><strong>{{translate("Parameter")}}</strong></p></div>
            <div class="update_view_value_col"><p><strong>{{translate("Value")}}</strong></p></div>
