    ...
    <div class="row ">
        ...
        <div class="col-lg-10  ">
            <div class="item_parent_container primary_background_color default_padding default_large_margin default_radius under_shadow">
                ...
                @for ($i = 1; $i <= 12; $i++)
                    <a class="no_ancor_decoration" href="/view/id">
                        <div class="default_radius under_shadow item_list grey_border item_list_margin">
                            ...
                            <p class="two_line_clamp"><strong>very good item, very good item, very good item, very good item, very good item,</strong></p>
                            <p ><strong class="remain_center price_p">440,<span class="Price_small_p">69</span> €</strong>    </p>
                            <a class="no_ancor_decoration" href="/add/cart/item/44">
