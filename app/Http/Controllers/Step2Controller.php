...
class Step2Controller extends Controller
{
    ...
    public function orderSubmit(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'lastname.required' => translate("The Last Name field is required."),
            ...
            'postcode.required' => translate("The Postcode field is required."),
            'address.required' => translate("The Address field is required."),
            'city.required' => translate("The City field is required."),
            'name.regex' => translate("The Name field can only contain letters and spaces."),
            'lastname.regex' => translate("The Last Name field can only contain letters and spaces."),
            'phone.regex' => translate("The Phone field must contain only digits and be between 7 and 15 digits."),
            'postcode.digits_between' => translate("The Postcode field must be between 4 and 10 digits."),
        ]);
